            ...
            <div className="p-4 sm:p-7 overflow-y-auto">
              ...
              <div className="mt-5 sm:mt-10 grid grid-cols-2 sm:grid-cols-3 gap-5">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-x-2">
                    <svg
                      className="size-5 size-on-print"
                      width={400}
                      height={248}
                      viewBox="0 0 400 248"
                      fill="none"
              ...
              <div className="mt-5 flex justify-end gap-x-2">
                <button
                  ...
                  onClick={() => downloadInvoicePdf(invoiceRef, receiptDtls)}
                >
                  <svg
                    className="shrink-0 size-4"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none no-print"
