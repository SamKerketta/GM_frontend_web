...
const Sidebar = () => {
  ...
  return (
    <aside
      ...
      aria-label="Sidenav"
    >
      <div className="overflow-y-auto py-5 px-3 h-full bg-menu border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 menu-top-right bg-white">
                ...
                ${
                  isActive
                    ...
                    >
                      ...
                      <span className="ml-3">{item.menuName}</span>
                    </Link>
                  </li>
                ) : (
                  <li>
                    <button
                      type="button"
                      className="flex items-center p-2 w-full text-base font-normal text-white rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 sidebar-text"
                      aria-controls="dropdown-pages"
                      data-collapse-toggle="dropdown-pages"
                    >
                      <svg
                        aria-hidden="true"
                        className="flex-shrink-0 w-6 h-6 transition duration-75 sidebar-text"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      >
        ...
        <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          {staticMenues.map((item) => {
            return (
              <React.Fragment key={item.menuId}>
                <li>
                  <Link
                    to={item.menuRoute}
                    className="flex items-center p-2 text-base font-normal text-white rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group sidebar-text"
                  >
                    <svg
                      aria-hidden="true"
                      className="w-6 h-6 transition duration-75"
